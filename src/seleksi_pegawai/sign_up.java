...
public class sign_up extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_iduser, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
     ...
     public void Simpan(){
        ...
        String notlp = txt_notlp.getText();
        String access = cmbaccess.getSelectedItem().toString();
        try {
            koneksi objkoneksi = new koneksi();
            Connection con = objkoneksi.bukakoneksi();
            Statement stat = con.createStatement();
            String sql = "insert into tbl_user (id_user, nama_user, username, password, alamat, email, no_telpn, access) values ('" + iduser + "','" + nama + "', '" + username + "', '" + password + "', '" + alamat + "', '" + email +"', '" + notlp +"', '" + access +"')";
