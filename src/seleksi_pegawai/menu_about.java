 ...
 * @author ALFIANSAH
 */
public class menu_about extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menu_about.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
